...
# intro_oo = Monster.create(mon_name: "Intro to Object Orientation",mon_health: 4,mon_attack: 2,quest_id: codechallenge.id)

# ass_lab = Monster.create(mon_name: "Associations One-to-many",mon_health: 5,mon_attack: 2,quest_id: codechallenge.id)

# cc_practice = Monster.create(mon_name: "Mock Code Challenge",mon_health: 6,mon_attack: 2,quest_id: codechallenge.id)

cc_mod1 = Monster.create(mon_name: "Mod1 Code Challenge",mon_health: 10,mon_attack: 3,quest_id: codechallenge.id)

# blog_talk = Monster.create(mon_name: "Blog Talk",mon_health: 4,mon_attack: 1,quest_id: mod1project.id)

# ar_intro = Monster.create(mon_name: "ActiveRecord::Base Intro",mon_health: 6,mon_attack: 2,quest_id: mod1project.id)

proj_intro = Monster.create(mon_name: "Project Week day 1",mon_health: 8,mon_attack: 2,quest_id: mod1project.id)

# proj_4 = Monster.create(mon_name: "Project Week day 4",mon_health: 12,mon_attack: 4,quest_id: mod1project.id)

proj_final = Monster.create(mon_name: "Project Presentation",mon_health: 13,mon_attack: 6,quest_id: mod1project.id)
