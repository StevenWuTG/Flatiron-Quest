...
office_hours = Support.create(support_name: "Went to office hours", support_health:2, support_attack:3)
sing = Support.create(support_name: "Sang and danced with Caryn before lecture", support_health:2, support_attack:1)
cats = Support.create(support_name: "Laughed at Caryn's cats", support_health:2, support_attack:1)
yoga = Support.create(support_name: "Practiced chair yoga", support_health:3, support_attack:1)
fun = Support.create(support_name: "Mandatory fun", support_health:2, support_attack:1)
solutions = Support.create(support_name: "Found solutions code", support_health:1, support_attack:4)
...
michelle = Support.create(support_name: "Michelle's accent made me smile", support_health:3, support_attack:1)
